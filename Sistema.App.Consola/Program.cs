...
namespace Sistema.App.Consola
{
    class Program
    {
        ...
        private static void UpdateMunicipio()
        {
            ...
            var nuevoMunicipio = _repoMunicipio.UpdateMunicipio(municipio);
            Console.WriteLine("---");
        ...
        private static void UpdateEstadio()
        {
            ...
            var nuevoEstadio = _repoEstadio.UpdateEstadio(estadio);
            Console.WriteLine("---");
        ...
        private static void AsignarMunicipio()
        {
            ...
            var  auxvar = _repoEstadio.GetEstadio(6).Nombre;
